...
export const useCreateAnnouncement = (): UseCreateAnnouncementValues => {
  ...
  const formik = useFormik({
    validationSchema: object({
      ...
      minimum_order_size: string().required(t('amountRequired')),
      maximum_order_size: string().required(t('amountRequired')),
      payment_method: object<UserPaymentMethod>().required(t('paymentMethodRequired')),
